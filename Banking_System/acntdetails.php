...
<body>
  ...
  <?php
    ...
    echo '<img style="float:left;display:inline-block;height:150px;width:150px;border:1px solid black;margin-top:0px;" src="../images/banklogo.jpg" alt="KUMEBE" title="KUMEBE">';
  ...
  <table class="table">
  <?php
  $stmt = $pdo->prepare('SELECT users.username, users.name, acntdetails.Account_no, acntdetails.Currency_type, acntdetails.balance, acntdetails.Opening_date
                FROM users, acntdetails WHERE users.user_id = :uid AND acntdetails.user_id = users.user_id');
