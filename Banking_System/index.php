	        ...
	        <img class="mySlides" src="../images/bank-5.jpg" >
					...
					<div class="flip-box-inner">
						<div class="flip-box-front">
							<img src="../images/img_paris.jfif" alt="Paris" style="width:300px;height:500px">
						</div>
						<div class="flip-box-back" style="width:300px;height:500px">
							<h2>KUNAL AGARWAL</h2><br><br>
							<p><i><b>A Genius Lives Just one storey above a Madman.</b></i></p>
						</div>
					</div>
					</div>
				</div>
				...
				<div class="flip-box-inner">
					...
					<div class="flip-box-back" style="width:300px;height:500px">
						<h2>UTKARSH</h2><br><br>
						<p><i><b>Never look back and go on.</b></i></p>
					</div>
				</div>
				</div>
				</div>
				...
				<div class="flip-box-inner">
					...
					<div class="flip-box-back" style="width:300px;height:500px">
						<h2>PRAVEEN</h2><br><br>
						<p><b><i>Failure is just a easy path to success.</i></b></p>
					</div>
				</div>
				</div>
				</div>
			...
			<!-- Footer -->
				<div id="footer">
					...
					<!-- Copyright -->
						<div class="copyright">
							<ul class="menu">
								<li>&copy; Untitled. All rights reserved</li><li>Developed and Maintained by : <a href="#">KMB & Co IT Team</a></li>
							</ul>
						</div>
...
<?php
	...
	echo '<img style="float:left;display:inline-block;height:150px;width:150px;border:1px solid black;margin-top:0px;" src="../images/banklogo.jpg" alt="KUMEBE Logo" title="KUMEBE">';
...
<div class="colo">
	<div class="col1">
		<h2 style="color:yellow;">KUMEBE Bank</h2>
	</div>
	<div class="col2">
